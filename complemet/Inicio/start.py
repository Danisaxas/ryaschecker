...
async def start(client, message):
    ...
    # Usamos el ID del mensaje actual como respuesta (es decir, si el comando /start se ejecuta como respuesta a otro mensaje)
    ...
    await client.send_message(
        ...
        reply_to_message_id=reply_to_message_id  # Responde al mensaje que ejecutó /start
    )
